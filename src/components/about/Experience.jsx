    ...
    return (
        <section className="py-32 px-4 bg-white relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center space-y-12 relative z-10">
                <div>
                    <h2 className="text-4xl lg:text-5xl font-serif text-[#1A2E05] mb-6">
                        Experience Over Belief
                    </h2>
                    <h3 className="text-2xl text-[#1A2E05] font-medium italic">
                ...
                <div className="text-xl text-gray-600 leading-loose font-light space-y-8">
                    ...
                    <p className="text-2xl text-[#1A2E05] font-medium">
