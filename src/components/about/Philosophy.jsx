...
export default function Philosophy() {
    return (
        <section className="py-24 px-4 bg-[#F7F8ED] relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto text-center relative z-10 border-2 border-[#1A2E05]/5 p-8 lg:p-14 rounded-3xl bg-white/50 backdrop-blur-sm">
                <h2 className="text-3xl lg:text-4xl font-serif text-[#1A2E05] mb-8">
                ...
                <div className="space-y-10">
                    ...
                    <blockquote className="text-2xl lg:text-3xl font-serif italic text-[#1A2E05] leading-normal px-8 py-4 border-l-4 border-gray-300 inline-block">
