    ...
    <div className="relative w-full  " ref={ref}>
      ...
      <div className="relative w-full h-[600px] overflow-hidden">
        ...
        >
          ...
          <motion.h2
            className="text-xl md:text-5xl lg:text-6xl font-bold mb-4 text-center rounded-lg p-2 Meditation & Yoga Insights text-white  "
         ...
         textShadow: "0.1px 0 black, 0 0.1px black, 0.1 px 0 black, 0 -0.1px black",  
          ...
          <motion.div
            className="flex items-center justify-center sm:text-10  text-lg font-semibold bg-white/90 backdrop-blur-sm px-6 py-3 rounded-full shadow-lg border border-white/20"
